...
public class StringBuilderTest {
    ...
    public void append_charSequence_1() {
        ...
        assertThat(foo, taintEquals(range(0, 1, 3).add(3, 5, 1)));
    }
    ...
    public void delete() {
        ...
        assertThat(foo.toString(), is("fo"));
        assertThat(foo, taintEquals(range(0, 1, 3).add(1, 2, 1)));
    }
    ...
    public void insert_string_2() {
        ...
        assertThat(foo.toString(), is("fbaroo"));
        assertThat(foo, taintEquals(range(0, 1, 1).add(4, 6, 1)));
    }
    ...
    public void insert_charSequence_1() {
        ...
        assertThat(foo, taintEquals(range(0, 1, 1).add(1, 3, 2).add(3, 5, 1)));
    }
