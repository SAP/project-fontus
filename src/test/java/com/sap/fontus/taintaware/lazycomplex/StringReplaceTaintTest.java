...
public class StringReplaceTaintTest {
    ...
    public void testReplace_1() {
        ...
        // taints *all* characters in the string
    ...
    public void testReplaceCharsequence_11() {
        ...
        IASString s2 = new IASString("this is a very long string to test if long strings can cause a problem here");
        IASString t = s1.replace("x", s2);

        assertEquals("hello x", s1.getString());
        assertEquals("this is a very long string to test if long strings can cause a problem here", s2.getString());
        assertEquals("hello this is a very long string to test if long strings can cause a problem here", t.getString());
        assertFalse(this.getTaintChecker().getTaint(s1));
        assertFalse(this.getTaintChecker().getTaint(s2));
        assertFalse(this.getTaintChecker().getTaint(t));
    }
