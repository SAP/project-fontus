...
public class StringBuilderTest {
    ...
    public void append_charSequence_1() {
        ...
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md3).add(3, 5, md1)));
    }
    ...
    public void delete() {
        ...
        assertThat(foo.toString(), is("fo"));
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md3).add(1, 2, md1)));
    }
    ...
    public void insert_string_2() {
        ...
        assertThat(foo.toString(), is("fbaroo"));
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md1).add(4, 6, md1)));
    }
    ...
    public void insert_charSequence_1() {
        ...
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md1).add(1, 3, md2).add(3, 5, md1)));
    }
