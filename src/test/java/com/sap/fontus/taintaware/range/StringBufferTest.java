...
public class StringBufferTest {
    ...
    public void append_charSequence_1() {
        ...
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, 3).add(3, 5, 1).done()));
    }
    ...
    public void delete() {
        ...
        assertThat(foo.toString(), is("fo"));
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, 3).add(1, 2, 1).done()));
    }
    ...
    public void insert_string_2() {
        ...
        assertThat(foo.toString(), is("fbaroo"));
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, 3).add(4, 6, 3)));
    }
    ...
    public void insert_charSequence_1() {
        ...
        MatcherAssert.assertThat(foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, 3).add(1, 3, 1).add(3, 5, 3)));
    }
