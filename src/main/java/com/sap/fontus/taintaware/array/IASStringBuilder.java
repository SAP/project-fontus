...
import com.sap.fontus.taintaware.shared.IASStringBuilderable;
...
public final class IASStringBuilder extends IASAbstractStringBuilder implements IASStringBuilderable {
    ...
    public IASStringBuilder(IASAbstractStringBuilderable s) {
        super(s);
    }
    ...
    public static IASStringBuilder fromStringBuilder(StringBuilder stringBuilder) {
