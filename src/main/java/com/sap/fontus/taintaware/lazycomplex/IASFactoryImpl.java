...
import com.sap.fontus.taintaware.shared.IASProperties;
...
public class IASFactoryImpl implements IASFactory {
    ...
    public Class<? extends IASProperties> getPropertiesClass() {
        return com.sap.fontus.taintaware.lazycomplex.IASProperties.class;
    }
    ...
    public IASProperties createProperties(Properties param) {
        return com.sap.fontus.taintaware.lazycomplex.IASProperties.fromProperties(param);
    }
}
