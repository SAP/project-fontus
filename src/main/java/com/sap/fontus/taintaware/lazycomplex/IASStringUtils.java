package com.sap.fontus.taintaware.lazycomplex;import com.sap.fontus.taintaware.shared.IASStringable;
...
public final class IASStringUtils {
    ...
    public static void arraycopy(Object src,
                                 ...
                                 int destPos,
                                 int length) {
        com.sap.fontus.taintaware.shared.IASStringUtils.arraycopy(src, srcPos, dest, destPos, length);
    }

    public static IASString fromObject(Object obj) {
        return (IASString) com.sap.fontus.taintaware.shared.IASStringUtils.fromObject(obj);
    }
    ...
    public static List<String> convertTStringList(List<IASStringable> tlst) {
        return com.sap.fontus.taintaware.shared.IASStringUtils.convertTStringList(tlst);
    }
    ...
    public static String[] convertTaintAwareStringArray(IASStringable[] arr) {
        return com.sap.fontus.taintaware.shared.IASStringUtils.convertTaintAwareStringArray(arr);
    }

    public static IASString concat(String format, Object... args) {
        return (IASString) com.sap.fontus.taintaware.shared.IASStringUtils.concat(format, args);
    }
