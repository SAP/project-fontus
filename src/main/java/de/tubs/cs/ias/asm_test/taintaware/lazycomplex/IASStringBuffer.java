...
public class IASStringBuffer extends IASAbstractStringBuilder implements IASStringBufferable {
    ...
    @Override
    public synchronized IASStringBuffer append(IASAbstractStringBuilderable str) {
        return (IASStringBuffer) super.append(str);
    }
