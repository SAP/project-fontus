...
public class IASFactoryImpl implements IASFactory {
    ...
    public Class<? extends IASProperties> getPropertiesClass() {
        return de.tubs.cs.ias.asm_test.taintaware.lazycomplex.IASProperties.class;
    }
    ...
    public IASProperties createProperties(Properties param) {
        return de.tubs.cs.ias.asm_test.taintaware.lazycomplex.IASProperties.fromProperties(param);
    }
}
