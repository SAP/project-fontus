...
public final class IASStringBuffer extends IASAbstractStringBuilder implements IASStringBufferable {
    ...
    public IASStringBuffer(IASAbstractStringBuilderable strb) {
        super(strb);
    }
    ...
    @Override
    public synchronized IASStringBuffer append(IASStringable toAppend) {
        return (IASStringBuffer) super.append(toAppend);
    }

    @Override
    public synchronized IASStringBuffer append(IASAbstractStringBuilderable toAppend) {
        return (IASStringBuffer) super.append(toAppend);
    }
    ...
    @Override
    public synchronized IASStringBuffer append(CharSequence charSequence) {
        return (IASStringBuffer) super.append(charSequence);
    }

    @Override
    public synchronized IASStringBuffer append(CharSequence charSequence, int start, int end) {
        return (IASStringBuffer) super.append(charSequence, start, end);
    }
    ...
    @Override
    public synchronized int compareTo(IASAbstractStringBuilderable iasStringBuilderable) {
