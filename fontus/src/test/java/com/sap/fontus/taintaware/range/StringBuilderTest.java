...
class StringBuilderTest {
    ...
    private IASStringBuilder foo;
    private IASStringBuilder bar;

    @BeforeEach
    void setup() {
        this.foo = new IASStringBuilder("foo");
        this.bar = new IASStringBuilder("bar");
    }
    ...
    void append_charSequence_1() {
        ...
        assertThat(this.foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md3).add(3, 5, md1)));
    }
    ...
    void delete() {
        ...
        assertThat(this.foo.toString(), is("fo"));
        assertThat(this.foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md3).add(1, 2, md1)));
    }
    ...
    void insert_string_2() {
        ...
        assertThat(this.foo.toString(), is("fbaroo"));
        assertThat(this.foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md1).add(4, 6, md1)));
    }
    ...
    void insert_charSequence_1() {
        ...
        assertThat(this.foo, TaintMatcher.taintEquals(RangeChainer.range(0, 1, md1).add(1, 3, md2).add(3, 5, md1)));
    }
