...
public final class IASMatcherReplacement {
    ...
    private IASMatcherReplacement(IASString clearedReplacementString, HashMap<Object, Integer> groups) {
        this.clearedReplacementString = clearedReplacementString;
        this.groups = groups;
    }

    public IASString doReplacement(Matcher m, IASString orig, IASAbstractStringBuilder emptyBuilder) {
        int lastIndex = -1;
        int shift = 0;
    ...
    public static IASMatcherReplacement createReplacement(IASString repl, IASAbstractStringBuilder emptyBuilder) {
